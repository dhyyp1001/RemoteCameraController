...
public class MainListData {
    ...
    public MainListData(String sName, String camIP, String camRtsp, String camHttp, String modIP, String modPort, String camId, String camPwd, String mediaUri, String owner, String manager, String operator) {
        this.sName = sName;
        this.camIP = camIP;
